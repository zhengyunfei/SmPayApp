package com.zero2ipo.pay.wxsmpay.demo;

import java.util.SortedMap;
import java.util.TreeMap;

import com.zero2ipo.pay.wxsmpay.utils.GetWxOrderno;
import com.zero2ipo.pay.wxsmpay.utils.RequestHandler;
import com.zero2ipo.pay.wxsmpay.utils.Sha1Util;
import com.zero2ipo.pay.wxsmpay.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wx889176fe2c1c0b0c";
	private static String appsecret = "5701ac02b5d64c4b7f420740e63cdfb4";
	private static String partner = "1280846501";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "z1h6e9n1g6y8u1n6f9e1i68zheng8yun";
	...
	public static void main(String[] args) {
	    ...
	    tpWxPay1.setSpbillCreateIp("123.57.29.68");
	...
	public static String getCodeUrl(){
		...
		tpWxPay1.setSpbillCreateIp("123.57.29.68");
		tpWxPay1.setTotalFee("0.01");
		String result=getCodeurl(tpWxPay1);
		return result;
	}
