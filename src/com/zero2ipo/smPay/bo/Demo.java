package com.zero2ipo.smPay.bo;

import com.zero2ipo.pay.wxsmpay.utils.GetWxOrderno;
import com.zero2ipo.smPay.utils.RequestHandler;
import com.zero2ipo.smPay.utils.Sha1Util;
import com.zero2ipo.smPay.utils.TenpayUtil;
...
public class Demo {
	...
	private static String appid = "wx5a70e438bf0481db";
	private static String appsecret = "086e2d620461e8ca2aa6be95395d59fd";
	private static String partner = "1317744501";
	//这个参数partnerkey是在商户后台配置的一个32位的key,微信商户平台-账户设置-安全设置-api安全
	private static String partnerkey = "1Q2W3E4R5t6y7u8i9o0pachengdikeik";
	//openId 是微信用户针对公众号的标识，授权的部分这里不解释
	private static String openId = "";
	//微信支付成功后通知地址 必须要求80端口并且地址不能带参数
	private static String notifyurl = "http://bj-sienwanmei.com/order/update.html";																	 // Key
